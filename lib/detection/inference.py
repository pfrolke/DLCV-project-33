...
flags.DEFINE_string(
    'checkpoint_path', 'checkpoint/model.ckpt', 'The path to the checkpoint file.')
flags.DEFINE_string(
    'config_file', 'projects/fashionpedia/configs/yaml/spinenet143_amrcnn.yaml', 'The config file template.')
flags.DEFINE_string(
